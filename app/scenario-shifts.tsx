...
export type ScenarioId = 'xrd' | 'bet' | 'furnace' | 'tga';
...
type Modal = 'deck' | 'guide' | 'bench' | 'sample' | 'evidence' | 'complete' | null;
type Scenario = {
...
function EquipmentGlyph({ type }: { type: string }) {
  ...
  return <div className="glyph glyph-tga"><i /><i /><b /><span /></div>;
}
