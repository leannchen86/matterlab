...
const tasks = [
  { title: 'Read the move note', pending: 'Move assigned', done: 'Move note read' },
  { title: 'Choose the correct container', pending: 'Two containers in the bay', done: 'Correct load secured' },
  { title: 'Move the material', pending: 'Waiting for a clear route', done: 'Material delivered' },
  ...
  { title: 'Separate uncertain results', pending: 'Two runs cross the gas change', done: 'Uncertain runs held' },
];
...
function getFacilityAction(phase: number, actions: (() => void)[]) {
  return [
    ...
    { tag: 'NEXT STEP', title: 'Separate results from before and after', metric: '2 uncertain runs', body: 'A passing check only proves the analyzer worked after the gas change.', label: 'REVIEW THE RESULTS', fn: actions[4], tone: 'warn' },
    { tag: 'MISSION COMPLETE', title: 'Move and gas change complete', metric: '6 / 6', body: 'The material moved safely and only trustworthy results will be reused.', label: 'VIEW SUMMARY', fn: actions[5], tone: 'ready' },
